export default function Head() {
  return (
    <>
      ...
      <meta name="description" content="I focus on developing user-friendly web applications that meet the client's requirements, with attention to detail, scalability, and performance." />
      <meta name="keywords" content="I focus on developing user-friendly web applications that meet the client's requirements, with attention to detail, scalability, and performance." />
      <meta property="og:site_name" content="Cavin Larry's Portfolio" />
      ...
      <title>CalaTech | Cavin - Web Developer</title>
    </>
  )
}
